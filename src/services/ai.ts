...
export const AI_MODELS: AIModel[] = [
  ...
  },
  {
    ...
    description: '복합 추론, 100만 토큰 컨텍스트',
    tier: 'premium',
  },
  // OpenAI GPT-5 시리즈
  {
  ...
  },
  {
    ...
    provider: 'openai',
    modelId: 'gpt-5-pro',
    description: '최상위 정밀도, 복합 추론용',
    tier: 'premium',
  },
  // Anthropic Claude 4.5 시리즈
  {
    id: 'claude-haiku',
    name: 'Claude 4.5 Haiku',
    provider: 'anthropic',
    modelId: 'claude-haiku-4-5-20250514',
    description: '저비용, 빠른 응답',
    tier: 'standard',
  },
  {
    id: 'claude-sonnet',
