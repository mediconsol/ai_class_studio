...
환자 70대 남자 폐렴 열남 항생제 투여중`,
  },
  {
    ...
    category: 'demo',
    prompt: `당신은 병원 간호사의 업무를 돕는 AI입니다.
...
(여기에 내용 입력)`,
  },
  {
    ...
    category: 'demo',
    prompt: `아래 내용을 환자도 이해할 수 있게 쉬운 말로 풀어서 설명해주세요.
전문 용어는 피하고, 일상적인 표현을 사용해주세요.
...
지속적인 저혈당 시 글루카곤 투여를 고려할 수 있습니다.`,
  },
  {
    ...
    category: 'demo',
    prompt: `아래 내용을 3줄 이내로 핵심만 요약해주세요.
가장 중요한 정보만 남기고 불필요한 내용은 제외해주세요.
