...
export const prompts: PromptTemplate[] = [
  {
    ...
    prompt: `당신은 병원 원무·행정 업무를 보조하는 역할입니다.
아래 민원 상황에 대해
...
{{데이터 붙여넣기}}`,
  },
  {
    ...
    category: 'admin',
    prompt: `아래 주제에 맞는 환자용 안내문을 작성해주세요.
...
- 이모지 사용 가능 (적절히)`,
  },
  {
    ...
    category: 'admin',
    prompt: `병원 [부서명]에서 자주 받는 질문 10가지와
...
- 추가 안내가 필요한 경우 문의처 안내`,
  },
  {
    ...
    category: 'admin',
    prompt: `위 응대 문구를 두 가지 버전으로 작성해주세요.
...
{{문구 붙여넣기}}`,
  },
  {
    ...
    prompt: `아래 민원 유형별로 표준 응대 문구를 각각 작성해주세요.
