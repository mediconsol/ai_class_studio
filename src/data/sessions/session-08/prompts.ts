...
export const prompts: PromptTemplate[] = [
  {
    ...
    prompt: `당신은 장기 입원 환자의 상태 요약을 보조하는 역할입니다.
아래 며칠간의 관찰 기록을 바탕으로
...
(기록 붙여넣기)`,
  },
  {
    ...
    category: 'nursing',
    suggestedDummyDataIds: ['s08-dd01'],
    prompt: `위 내용을 다음 형식의 요약 시트로 정리해주세요:
...
└────────────────────────────────────┘`,
  },
  {
    ...
    prompt: `위 기록에서 다음 항목별 변화 추이를 표로 정리해주세요:
...
(기록 붙여넣기)`,
  },
  {
    ...
    category: 'nursing',
    suggestedDummyDataIds: ['s08-dd02'],
    prompt: `아래는 환자의 입원 기간 전체 관찰 기록입니다.
퇴원 요약 초안을 작성해주세요.
...
(기록 붙여넣기)`,
  },
  {
    ...
    category: 'nursing',
    suggestedDummyDataIds: ['s08-dd01', 's08-dd02'],
    prompt: `아래 환자 기록을 다학제 회의(팀 컨퍼런스)에서
