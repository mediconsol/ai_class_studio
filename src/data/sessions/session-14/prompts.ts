...
export const prompts: PromptTemplate[] = [
  {
    ...
    prompt: `당신은 의료기관 심사·적정성평가 대응 문서 작성을 보조하는 역할입니다.
...
{{메모 붙여넣기}}`,
  },
  {
    ...
    category: 'admin',
    prompt: `위 대응 문서의 근거 자료를 더 상세하게 정리해주세요.
...
- 평가 기준별로 어떤 근거 자료가 해당하는지 매핑`,
  },
  {
    ...
    category: 'admin',
    prompt: `아래 평가 항목들을 모두 같은 형식으로 정리해주세요.
...
{{내용 붙여넣기}}`,
  },
  {
    ...
    category: 'admin',
    prompt: `작년 평가 대응 내용과 올해 운영 현황을 비교하여
변경된 사항을 정리해주세요.
