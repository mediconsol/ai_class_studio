...
- 구체적인 피드백`,
  },
  {
    ...
    category: 'general',
    prompt: `내 AI 결과물 적용 시 발생할 수 있는 리스크를 분석해주세요.
...
- 현실적인 리스크 중심`,
  },
  {
    ...
    category: 'general',
    prompt: `동료에게 AI 결과물을 공유할 때 사용할 메시지를 작성해주세요.
...
- 강요 아닌 제안`,
  },
  {
    ...
    category: 'general',
    prompt: `AI 결과물을 공유한 후 피드백을 받을 질문을 만들어주세요.
