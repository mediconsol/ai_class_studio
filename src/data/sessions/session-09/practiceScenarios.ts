...
의사에게 보고 완료`
      },
      {
        id: 's09-prac01-d2',
        title: '욕실 낙상 사고 메모',
        description: '샤워 중 발생한 낙상 사고',
        category: 'safety',
        format: 'text',
        dataType: 'memo',
        characteristics: '욕실에서 발생한 낙상으로, 미끄러운 바닥 환경이 기록되어 있습니다.',
        content: `[사고 상황 메모]
...
X-ray 오더됨`
      ...
      {
        id: 's09-prac01-d3',
        title: '의식 저하 환자 낙상 메모',
        description: '인지기능 저하 환자의 침대 추락',
        category: 'safety',
        format: 'text',
        dataType: 'memo',
        characteristics: '인지기능 저하로 억제대를 풀고 일어나다 발생한 사고입니다.',
        content: `[사고 상황 메모]
...
L-tube 다시 넣을지는 의사 선생님 결정 기다려야 될 것 같아요.`
      ...
      {
        id: 's09-prac03-d2',
        title: 'Foley 카테터 자가 제거 음성 메모',
        description: '요도관 자가 제거 발견 직후 음성 녹음',
        category: 'safety',
        format: 'text',
        dataType: 'voice',
        characteristics: '급하게 녹음된 음성으로 중복 표현과 구어체가 많습니다.',
        content: `[음성 녹음 전사]

아 네, 지금 404호 김OO 환자, 남자분 70대요.
폴리가 빠져 있어요, 자가로 뽑은 것 같아요.

발견한 게 지금... 오후 10시 15분이에요.
야간인데 보호자분도 안 계셨고요.

환자분이 좀 불안정하셨거든요, 섬망 있으시고.
손 억제대 하고 있었는데 풀려있었어요.

환자 상태는요, 혈뇨가 좀 보여요.
통증 있냐고 물어봤는데 있다고 하시고.
의식은 명료한데 지남력이 떨어지세요.

지금 출혈량 확인하고요, 당직 선생님한테 연락했어요.
도뇨 다시 할지는 확인받아야 될 것 같고요.`
      },
      {
        id: 's09-prac03-d3',
        title: 'IV 라인 자가 제거 음성 메모',
        description: '수액 라인 자가 제거 발견 음성 녹음',
        category: 'safety',
        format: 'text',
        dataType: 'voice',
        characteristics: '여러 정보가 섞여 있고 순서가 뒤죽박죽인 음성 메모입니다.',
        content: `[음성 녹음 전사]

네 지금 302호인데요, 어... 이OO 환자분이요.
수액이, 아 IV 라인이 빠져있어요. 자가 발관이에요.

아 그 전에 말씀드리면, 환자분이 치매가 있으시거든요.
미텐 끼고 있었는데 아마 풀리셨나 봐요.

시간은... 아 네 지금이 새벽 4시 10분이에요.
간병인분이 발견하셔서 알려주셨어요.

환자 상태요? 그냥 멍하게 계세요.
삽입 부위 보니까 약간 부어있고 피가 났는데 지금은 멈췄어요.
혈압은 정상이에요. 130/80 정도.

지금 지혈하고요, 새로 잡아야 하는데 혈관이 안 좋아서...
담당 선생님한테 보고할게요.`
      }
    ],
    prompts: [
...
X-ray 촬영 예정`
      ...
      {
        id: 's09-prac04-d2',
        title: '투약 오류 메모 (추측 포함)',
        description: '원인 추측이 섞인 투약 오류 메모',
        category: 'safety',
        format: 'text',
        dataType: 'flawed',
        trapPoints: [
          '"업무가 바빠서 확인을 못 함" - 원인 추측/변명',
          '"약 포장이 비슷해서 헷갈렸음" - 원인 추측',
          '"환자가 말을 안 해서 모름" - 책임 전가'
        ],
        characteristics: '투약 오류에 대해 변명성 원인 추측이 포함되어 있습니다.',
        content: `[사고 상황 메모]
...
상황:
아침 투약 시 고혈압약 대신 당뇨약을 투여함
업무가 바빠서 5-Right 확인을 못 함
약 포장이 비슷해서 헷갈렸음
환자가 말을 안 해서 몰랐음
...
원래 약 투여 보류 중`
      ...
      {
        id: 's09-prac04-d3',
        title: '욕창 발생 메모 (판단 포함)',
        description: '사후 판단이 섞인 욕창 발생 보고',
        category: 'safety',
        format: 'text',
        dataType: 'flawed',
        trapPoints: [
          '"체위변경을 더 자주 했어야 했는데" - 사후 판단',
          '"보호자가 제대로 못 돌봐서" - 책임 전가',
          '"영양 상태가 나빠서 생긴 것 같음" - 원인 추측'
        ],
        characteristics: '욕창 발생에 대한 사후 판단과 책임 전가 표현이 포함되어 있습니다.',
        content: `[사고 상황 메모]
...
상황:
천골 부위 2단계 욕창 발견
체위변경을 더 자주 했어야 했는데 2시간마다만 함
보호자가 제대로 못 돌봐서 발생한 것 같음
영양 상태가 나빠서 생긴 것 같음
...
X-ray 촬영 오더 확인`
      },
      {
        id: 's09-prac05-d2',
        title: '약물 부작용 발생 사고',
        description: '약물 투여 후 부작용이 발생한 사고',
        category: 'safety',
        format: 'text',
        dataType: 'memo',
        characteristics: '약물 투여와 부작용 발생의 시간 관계가 명확한 사고입니다.',
        content: `[사고 상황 메모]
...
알레르기 반응 기록 업데이트`
      },
      {
        id: 's09-prac05-d3',
        title: '수혈 중 반응 발생',
        description: '수혈 도중 발생한 이상 반응 사고',
        category: 'safety',
        format: 'text',
        dataType: 'memo',
        characteristics: '수혈 관련 사고로 즉각적인 중단과 보고가 필요한 상황입니다.',
        content: `[사고 상황 메모]
...
상황:
농축적혈구 수혈 시작 30분 경과 시점
오한 및 발열 호소
수혈 전 체온 36.5도 → 수혈 중 38.2도
...
□ 보호자 설명 및 반응 기록`,
  ...
  "incident_report": {
    ...
    "immediate_actions": [
      ...
      {
        id: 's09-prac06-d2',
        title: '투약 오류 JSON 데이터',
        description: 'JSON 형식의 투약 오류 사고 데이터',
        category: 'safety',
        format: 'json',
        dataType: 'memo',
        characteristics: '투약 오류 관련 상세 정보가 구조화된 JSON 데이터입니다.',
        content: `{
  "incident_report": {
    "incident_type": "투약 오류",
    "patient": {
    ...
    "medication_error": {
      "prescribed_med": "암로디핀 5mg",
      "administered_med": "글리메피리드 2mg",
      "route": "경구",
      "error_type": "잘못된 약물 투여"
    },
    "occurrence": {
      "date": "2024-02-01",
      "time": "08:00",
      "discovery_time": "10:30",
      "discovered_by": "담당 간호사"
    },
    "patient_status": {
      "consciousness": "명료",
      "blood_sugar": "85 mg/dL",
      "symptoms": "없음",
      "vital_signs": {
        "BP": "135/85",
        "PR": "78",
    ...
    "immediate_actions": [
      ...
      {
        id: 's09-prac06-d3',
        title: '자가 발관 JSON 데이터',
        description: 'JSON 형식의 자가 발관 사고 데이터',
        category: 'safety',
        format: 'json',
        dataType: 'memo',
        characteristics: 'L-tube 자가 발관 사고가 구조화된 JSON 형식입니다.',
        content: `{
  "incident_report": {
    "incident_type": "자가 발관",
    "patient": {
      ...
      "room": "410호",
      "diagnosis": "뇌졸중",
      "cognitive_status": "경도 인지저하"
    },
    "device": {
      "type": "L-tube (비위관)",
      "insertion_date": "2024-01-20",
      "last_check": "2024-01-25 09:00"
    },
    "occurrence": {
      "date": "2024-01-25",
      "time": "14:30",
      ...
      "restraint_status": "미적용"
    },
    "patient_status": {
      "consciousness": "명료",
      "respiratory": "안정",
      "abdominal": "불편감 없음",
      "nasal_bleeding": false
    },
    "immediate_actions": [
      "활력징후 측정",
      "담당의 보고",
