...
export type PromptCategory = 'nursing' | 'admin' | 'general' | 'demo' | 'safety' | 'infection' | 'sop';
...
export type DummyDataCategory = 'nursing' | 'admin' | 'patient' | 'document' | 'safety' | 'infection' | 'sop';
